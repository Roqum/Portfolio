...
return (
    <>
        ...
        <div className="container pb-5 px-5 mx-auto w-75 fc-gray800 bg-gray900 min-vh-100 ">
            <div className='h3 text-center py-5'><span className='fc-gray800'>About me</span></div>
            ...
            <p>
                ...
                At the age of 13 inspired by my cousin, my passion for programming began. Eagerly, I took on the challenge of mastering C++, 
                considered the most formidable language at this time. Soon, I recognized that game development resonated 
                ...
                During my schooldays, I cluelessly started programming games and experimentally played around with different technologies 
            ...
            <p>
                Coming toward the end of my study I plunge my self back in game development topic by reading books, watching videos 
                and programming games again. I looking forward to start my career as a game programmer in the industry and trying to prepare
                myself as good as possible for this upcoming step. 
            </p>
            <p>
                As my interest is not in programming alone, I am very excited to work in
                a team of specialist of different fields. I am curious, finding joy in exploring, learning and trying new stuff. 

    ...
    return (
        <> 
            <div className='container pt-5 fc-gray800'>     
                ...
                <p>
                    This 
                    <a className='link-underline-opacity-50 link-light link-underline-opacity-75-hover fc-orange' href="https://github.com/Roqum/Precedural_HextileMap_Generator/blob/master/Assets/Scripts/Map/Hexagon.cs"> Hexagon Class </a> 
                ...
                <p>
                    The 
                    <a className='link-underline-opacity-50 link-light link-underline-opacity-75-hover' href="https://github.com/Roqum/Precedural_HextileMap_Generator/blob/master/Assets/Scripts/Map/GridGenerator.cs"> map generator class </a>
                ...
                <video autoPlay className='w-75' muted='true' loop>
                    <source src="https://david-burgstaller.com/api/video/MapGeneratorSize.mp4" type="video/mp4" />
                </video>
                <p>
                    As you can see, a basic "W,A,S,D" movement is also added, so the map can be explored.
                </p>
                <p className='mt-5'>
                ...
                <p className='mt-5'>
                    My goal was achieved, I got more used to the Unity engine, learned how procedural generation can be done and even learned some stuff about mesh creation and hexagon math. 
                    <br />
                    This procedural generated map could be a good foundation for a strategy game
                </p>
            </div> 
        </>
    );
